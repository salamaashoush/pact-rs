...
impl DbSerializer for JsonSerializer {
    fn serialize(&self, value: &PactValue) -> DbResult<Vec<u8>> {
...
pub fn default_serializer() -> impl DbSerializer {
    CborSerializer::new()
}
