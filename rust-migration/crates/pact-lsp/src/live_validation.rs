...
impl LiveValidationProvider {
    ...
    fn create_parse_error_diagnostic(&self, _error: pact_syntax::ParseError, _text: &str) -> Result<EnhancedDiagnostic, String> {
    ...
    fn validate_governance(&self, _diagnostics: &mut Vec<EnhancedDiagnostic>, _governance: &pact_syntax::Governance, _span: &pact_lexer::Span, _lines: &[&str]) -> Result<(), String> { Ok(()) }
    ...
    fn convert_schema_to_type(&self, schema: &pact_syntax::Defschema) -> SchemaType {
    ...
    fn add_bindings_to_context(&self, _context: &mut ValidationContext, _bindings: &[pact_syntax::Binding]) {
    ...
    fn check_unused_imports(&self, _diagnostics: &mut Vec<EnhancedDiagnostic>, _program: &pact_syntax::Program, _lines: &[&str]) -> Result<(), String> { Ok(()) }
    fn check_unreachable_code(&self, _diagnostics: &mut Vec<EnhancedDiagnostic>, _program: &pact_syntax::Program, _lines: &[&str]) -> Result<(), String> { Ok(()) }
    fn check_missing_documentation(&self, _diagnostics: &mut Vec<EnhancedDiagnostic>, _program: &pact_syntax::Program, _lines: &[&str]) -> Result<(), String> { Ok(()) }
    fn validate_capability_usage(&self, _diagnostics: &mut Vec<EnhancedDiagnostic>, _program: &pact_syntax::Program, _lines: &[&str], _context: &ValidationContext) -> Result<(), String> { Ok(()) }
