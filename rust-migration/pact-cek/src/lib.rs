...
pub mod architecture_validation {
    ...
    pub fn validate_cek_value() {
        ...
        let _user_closure = CanApply::C(Closure {
            name: "test".to_string(),
            args: vec![],
            body: pact_ir::CoreTerm::Constant(pact_ir::Literal::LUnit, pact_shared_types::SpanInfo::empty()),
    ...
    pub fn validate_continuations() {
        ...
        let info = pact_shared_types::SpanInfo::empty();
    ...
    pub fn validate_error_handling() {
        ...
        let _try_handler = CEKErrorHandler::CEKHandler {
            env,
            recovery: pact_ir::CoreTerm::Constant(pact_ir::Literal::LUnit, pact_shared_types::SpanInfo::empty()),
            cont: Cont::Mt,
        ...
        let _enforce_one = CEKErrorHandler::CEKEnforceOne {
            env: env2,
            info: pact_shared_types::SpanInfo::empty(),
            current: pact_ir::CoreTerm::Constant(pact_ir::Literal::LBool(true), pact_shared_types::SpanInfo::empty()),
            remaining: vec![],
            cont: Cont::Mt,
            error_state: ErrorState::empty(),
            next_handler: Box::new(CEKErrorHandler::CEKNoHandler),
    ...
    pub fn validate_eval_monad() {
        ...
        let _error_comp = EvalM::<i32>::throw_error(
            pact_errors::PactError::PEExecutionError(
                pact_errors::EvalError::RuntimeError("test".to_string()),
                vec![],
...
impl CEKMachine {
    ...
    ) -> Result<CEKEnv, pact_errors::PactErrorI> {
