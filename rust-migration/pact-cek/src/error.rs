...
pub struct CallFrame {
    ...
    pub function_name: pact_errors::FullyQualifiedName,
    /// Function arguments as PactValues
    pub arguments: Vec<pact_values::PactValue>,
    /// Function type (defun, defcap, defpact)
    pub function_type: pact_errors::StackFunctionType,
...
impl UserRecoverableError {
    ...
    pub fn into_pact_error(self, span: SpanInfo) -> PactErrorI {
        use pact_errors::{EvalError, PactError};
