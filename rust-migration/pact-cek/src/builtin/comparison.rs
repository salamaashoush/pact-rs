...
pub fn register_comparison_builtins(builtin_env: &mut BuiltinEnv) -> Result<(), pact_errors::PactErrorI> {
        ...
        match args.as_slice() {
            ...
            _ => {
                ...
                EvalM::throw_error(pact_errors::PactError::PEExecutionError(
                    pact_errors::EvalError::InvalidArgument(
...
fn lit_cmp_gassed(expected_ordering: Ordering, v1: &CEKValue, v2: &CEKValue) -> EvalM<bool> {
    match (v1, v2) {
        ...
        (CEKValue::VPactValue(PactValue::Integer(i)), CEKValue::VPactValue(PactValue::Decimal(d))) => {
            ...
            let i_as_decimal = pact_values::Decimal::from(i.clone());
